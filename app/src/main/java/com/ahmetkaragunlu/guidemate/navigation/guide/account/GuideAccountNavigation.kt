...
@Composable
fun GuideAccountNavigation(
    startDestination: GuideAccountStart,
    onClose: () -> Unit,
) {
    val accountNavController = rememberNavController()
    val navBackStackEntry by accountNavController.currentBackStackEntryAsState()
    val titleResId = navBackStackEntry?.destination.guideAccountTitleResId()
    ...
    Scaffold(
        ...
        NavHost(
            ...
            guideAccountNavGraph(onAboutSaved = onClose)
        }
    }
}
