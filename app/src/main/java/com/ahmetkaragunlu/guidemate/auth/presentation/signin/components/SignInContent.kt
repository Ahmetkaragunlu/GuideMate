...
internal fun SignInScreenContent(
    ...
    Column(
        ...
        GoogleSignInButton(enabled = !screenState.isLoading, onClick = onGoogleSignInClick)
...
private fun SignInFormSection(
    ...
    if (retryAfterSeconds > 0) {
        ...
        Text(
            text = pluralStringResource(R.plurals.login_retry_wait, seconds, seconds),
...
internal fun Long.toResourceQuantity(): Int =
