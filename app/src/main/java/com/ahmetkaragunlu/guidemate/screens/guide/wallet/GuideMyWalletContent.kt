...
import com.ahmetkaragunlu.guidemate.screens.guide.wallet.components.WalletCard
import com.ahmetkaragunlu.guidemate.screens.guide.wallet.components.WalletTransactionItem
import com.ahmetkaragunlu.guidemate.screens.guide.wallet.components.simpleVerticalScrollbar
...
internal fun GuideMyWalletContent(
    ...
    Column(
        ...
        WalletCard(
            formattedBalance = uiState.availableBalanceMinor.toLocalCurrencyFromMinorUnit(),
